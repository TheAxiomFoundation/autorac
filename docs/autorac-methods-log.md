...
- Primary evidence paths:
  ...
  - [snap_state_uses_child_support_deduction_tx.meta.yaml](../../rac-us-tx/sources/targets/txhhs/twh/current-effective/snap_state_uses_child_support_deduction_tx.meta.yaml)
  - [snap_self_employment_expense_based_deduction_applies_tx.meta.yaml](../../rac-us-tx/sources/targets/txhhs/twh/current-effective/snap_self_employment_expense_based_deduction_applies_tx.meta.yaml)
...
- Primary evidence paths:
  ...
  - [test_validator_pipeline.py](../tests/test_validator_pipeline.py)
  - Archived Texas AKN document: `~/.arch/us-tx/txhhs/twh/current-effective/akn/source.akn.xml`
  - [snap_standard_medical_expense_deduction_tx.meta.yaml](../../rac-us-tx/sources/targets/txhhs/twh/current-effective/snap_standard_medical_expense_deduction_tx.meta.yaml)
  - [snap_homeless_shelter_deduction_available_tx.meta.yaml](../../rac-us-tx/sources/targets/txhhs/twh/current-effective/snap_homeless_shelter_deduction_available_tx.meta.yaml)
...
- Primary evidence paths:
  ...
  - [test_validator_pipeline.py](../tests/test_validator_pipeline.py)
  - Archived Texas AKN document: `~/.arch/us-tx/txhhs/twh/current-effective/akn/source.akn.xml`
  - [snap_tanf_non_cash_gross_income_limit_fpg_ratio_tx.meta.yaml](../../rac-us-tx/sources/targets/txhhs/twh/current-effective/snap_tanf_non_cash_gross_income_limit_fpg_ratio_tx.meta.yaml)
  - [snap_tanf_non_cash_asset_limit_tx.meta.yaml](../../rac-us-tx/sources/targets/txhhs/twh/current-effective/snap_tanf_non_cash_asset_limit_tx.meta.yaml)
...
- Hypothesis:
  - The slice-first SNAP manual lane had drifted from the intended stack. The correct architecture is to keep full policy documents in the Atlas archive under `raw/` and `akn/`, then let AutoRAC consume archive-backed AKN section extracts rather than treating loose `sources/slices/*.txt` files as primary legal authority.
- Effect:
  ...
  - Added archive-backed `source_backing` metadata so AutoRAC can resolve authoritative Texas manual content from `~/.arch/us-tx/.../akn/source.akn.xml`, while the repo only keeps target sidecars under `sources/targets/...`.
- Primary evidence paths:
  - [evals.py](../src/autorac/harness/evals.py)
  - [cli.py](../src/autorac/cli.py)
  - [test_evals.py](../tests/test_evals.py)
