...
CREATE TABLE IF NOT EXISTS axiom_encode.agent_transcripts (
...
ON axiom_encode.agent_transcripts
FOR ALL
TO service_role
USING (true)
WITH CHECK (true);

COMMENT ON TABLE axiom_encode.agent_transcripts IS 'Automatic logging of agent transcripts';
